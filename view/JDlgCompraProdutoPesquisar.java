 ...
 * @author u07329163139
 */
public class JDlgCompraProdutoPesquisar extends javax.swing.JDialog {

    /**
     * Creates new form JDlgCompraProdutoPesquisar
     */
    
    
    CompraProdutosControle compraProdutosControle;
    JDlgCompraProduto jDlgCompraProduto;
    public JDlgCompraProdutoPesquisar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jBtnOkayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnOkayActionPerformed
        ...
        CompraProdutoRal usuarios = compraProdutosControle.getBean(rowSel);
        jDlgCompraProduto.beanView(usuarios);
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgCompraProdutoPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgCompraProdutoPesquisar dialog = new JDlgCompraProdutoPesquisar(new javax.swing.JFrame(), true);
