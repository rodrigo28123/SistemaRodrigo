...
FuncionarioControle funcionarioControle;
    ...
    public jDlgConsultaFuncionario(java.awt.Frame parent, boolean modal) {
        ...
        funcionarioControle.setList(new ArrayList());
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTxtEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 339, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(65, 65, 65)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addComponent(jTxtSalario, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBtnConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConsultarActionPerformed
        // TODO add your handling code here:
        List lista;
        if (jTxtEmail.getText().equals("") && jTxtSalario.getText().equals("")){

            lista =  funcionarioDAO.listAll();

             funcionarioControle.setList(lista);
            jTable1.setModel(funcionarioControle);
        }else{
            if(!jTxtEmail.getText().equals("") && !jTxtSalario.getText().equals("")){
                lista =  funcionarioDAO.listEmailSalario(jTxtEmail.getText(), Util.strDouble(jTxtSalario.getText()));
                 funcionarioControle.setList(lista);
                jTable1.setModel(funcionarioControle);
            }else{
                if ( !jTxtEmail.getText().equals("")){
                    lista =  funcionarioDAO.listEmail(jTxtEmail.getText());
                     funcionarioControle.setList(lista);
                    jTable1.setModel(funcionarioControle);
                }else{
                    lista =  funcionarioDAO.listSalario(Util.strDouble(jTxtSalario.getText()));
                     funcionarioControle.setList(lista);
                    jTable1.setModel(funcionarioControle);
                }
            }
